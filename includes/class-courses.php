    ...
    class courses {
        ...
        function view_mode( $_id=null ) {
            ...
            foreach ($results as $index => $result) {
                ...
                $output .= '<td><select name="_teaching_id_'.$index.'" style="max-width:10%;">'.self::select_teachings($results[$index]->teaching_id).'</select></td>';
            ...
            $output .= '<td><select name="_teaching_id" style="max-width:10%;">'.self::select_teachings().'</select>'.'</td>';
            $output .= '</tr>';
